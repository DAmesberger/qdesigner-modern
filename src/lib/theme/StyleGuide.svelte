  ...
  <div class={theme.spacing.page.maxWidth}>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        {#each colors as color}
          <div class="text-center">
            <div
              class="{color.class} {color.textClass} h-24 rounded-lg flex items-center justify-center font-medium shadow-sm"
            >
              Aa
            </div>
    ...
    <div class={theme.components.container.section}>
      ...
      <div class="flex flex-wrap gap-4 mb-8">
        {#each buttonVariants as [name, classes]}
          <button
            class="{classes} {theme.components.button.sizes.md} rounded-md {theme.semantic
              .focusRing}"
          >
      ...
      <div class="flex flex-wrap items-center gap-4">
        {#each buttonSizes as [size, classes]}
          <button
            class="{theme.components.button.variants.default} {classes} rounded-md {theme.semantic
              .focusRing}"
          >
    ...
    <div class={theme.components.container.section}>
      ...
      <div class="grid gap-6 max-w-md">
        <div>
          <label for="input-demo" class="{theme.components.form.label} mb-2 block"
            >Input Field</label
          >
          <input
            id="input-demo"
            ...
            class={theme.components.form.input}
          />
        </div>

        <div>
          <label for="textarea-demo" class="{theme.components.form.label} mb-2 block"
            >Textarea</label
          >
          <textarea
            id="textarea-demo"
            placeholder="Enter multiple lines..."
            class={theme.components.form.textarea}
          ></textarea>
        </div>

        <div>
          <label for="select-demo" class="{theme.components.form.label} mb-2 block">Select</label>
          <select id="select-demo" class={theme.components.form.select}>
    ...
    <div class={theme.components.container.section}>
      ...
      <div class={theme.spacing.stack.md}>
        <div class="{theme.components.container.card} p-6">
          ...
          <p class={theme.semantic.textSecondary}>
            Used for grouping related content with subtle elevation
          </p>
        </div>

        <div class={theme.components.container.well}>
          <h4 class="{theme.typography.label} mb-1">Well Container</h4>
          <p class="{theme.typography.bodySmall} {theme.semantic.textSecondary}">
            Used for inline tips or secondary information
          </p>
        </div>
      </div>
    </div>
    ...
    <div class={theme.components.container.section}>
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <span class="{theme.components.badge.default} {theme.components.badge.destructive}"
          >Destructive</span
        >
        <span class="{theme.components.badge.default} {theme.components.badge.outline}"
          >Outline</span
        >
      </div>
    </div>
      ...
      <div class={theme.spacing.stack.sm}>
        {#each ['xs', 'sm', 'md', 'lg', 'xl'] as const as size}
          <div class="flex items-center gap-4">
            ...
            <div
              class="{theme.semantic.bgSubtle} h-4 {theme.spacing.stack[size].replace(
                'space-y',
                'w'
              )}"
            ></div>
    ...
    <div class={theme.components.container.section}>
      ...
      <div class="{theme.components.questionCard.base} p-4 mb-4">
        ...
        <p class="{theme.semantic.textSecondary} text-sm">
          This is how questions appear in the designer
        </p>
      </div>
      ...
      <div class="{theme.components.container.card} p-4">
        ...
        <div class={theme.components.propertyPanel.section}>
          <label class="{theme.components.form.label} mb-2 block" for="prop-input"
            >Property Name</label
          >
          <input
            type="text"
            id="prop-input"
            class={theme.components.propertyPanel.input}
            placeholder="Enter value..."
          />
        </div>
        <div class="">
          <label class="{theme.components.form.label} mb-2 block" for="prop-select"
            >Another Property</label
          >
          <select id="prop-select" class={theme.components.form.select}>
    ...
    <div class={theme.components.container.section}>
      ...
      {#if showCode}
        <pre class="{theme.components.container.well} overflow-x-auto"><code
