      ...
      {#if editing}
        <button
          ...
          class="px-3 py-1.5 text-sm font-medium text-primary
            bg-primary/10 rounded-md hover:bg-primary/20
            transition-colors"
  ...
  <div class="flex gap-4">
    ...
    >
      ...
      {#if layout.widgets.length === 0}
        <div
          class="col-span-12 flex flex-col items-center justify-center py-16 text-muted-foreground border-2 border-dashed border-border rounded-lg"
        >
