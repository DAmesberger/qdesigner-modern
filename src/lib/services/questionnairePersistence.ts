  ...
  static async saveQuestionnaire(
    ...
    try {
      const content = {
        ...
        versionMajor: questionnaire.versionMajor,
        versionMinor: questionnaire.versionMinor,
        versionPatch: questionnaire.versionPatch,
  ...
  static async loadQuestionnaire(projectId: string, questionnaireId: string): Promise<LoadResult> {
    try {
      ...
      const questionnaire: Questionnaire = {
        ...
        versionPatch: (content as DynamicValue).versionPatch ?? data.version_patch ?? 0,
