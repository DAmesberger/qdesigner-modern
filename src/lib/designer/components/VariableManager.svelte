<script lang="ts">
  ...
  import type { Variable, VariableType } from '$lib/questionnaire/types/questionnaire';
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
      ...
      <div class="space-y-4">
        <div>
          ...
          <input
            type="text"
            bind:value={editingVariable ? editingVariable.name : newVariable.name}
        ...
        <div>
          ...
          <select
            bind:value={editingVariable ? editingVariable.type : newVariable.type}
            class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        <div>
          ...
          <input
            type="text"
            bind:value={editingVariable ? editingVariable.defaultValue : newVariable.defaultValue}
            class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div>
          ...
          <textarea
            bind:value={editingVariable ? editingVariable.formula : newVariable.formula}
            rows="3"
        ...
        <div>
          ...
          <input
            type="text"
            bind:value={editingVariable ? editingVariable.description : newVariable.description}
            class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
