<script lang="ts">
  ...
  const shapeContent = $derived(() => {
    if (question.config.stimulus.type === 'shape' && typeof question.config.stimulus.content === 'object') {
...
<div class="designer-panel">
      ...
      <div class="subsection">
        <div class="form-group">
          ...
          <div class="preset-selector">
            <select 
              bind:value={selectedShapePreset}
              class="select"
            >
  ...
  <div class="section">
    ...
    <div class="form-group">
      ...
      <select 
        id="response-type"
        bind:value={question.config.response.type}
        class="select"
      >
    ...
    {#if question.config.response.type === 'keyboard'}
      ...
      {#if question.config.response.requireCorrect}
        <div class="form-group">
          ...
          <select 
            id="correct-key"
            bind:value={question.config.response.correctKey}
            class="select"
          >
  ...
  <div class="section">
    ...
    <div class="form-group">
      ...
      <select 
        id="target-fps"
        bind:value={question.config.rendering.targetFPS}
        class="select"
      >
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.rendering.vsync}
          class="checkbox"
        />
