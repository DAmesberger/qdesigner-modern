...
<div class="designer-panel">
  ...
  <div class="form-group">
    ...
    <select 
      id="max-size"
      bind:value={question.config.maxSize}
      class="select"
    >
  ...
  <div class="section">
    ...
    <div class="form-group">
      ...
      <select 
        id="storage"
        bind:value={question.config.storage}
        class="select"
      >
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.saveMetadata}
          class="checkbox"
        />
  ...
  <div class="section">
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.dragDrop}
          class="checkbox"
        />
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.showPreview}
          class="checkbox"
        />
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.autoUpload}
          class="checkbox"
        />
