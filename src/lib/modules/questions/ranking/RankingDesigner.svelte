...
<div class="designer-panel">
  ...
  <div class="section">
    ...
    {#if question.config.items.length < 2}
      <p class="help-text warning">
        Add at least 2 items for a valid ranking task
      </p>
    {/if}
  </div>
  ...
  <div class="section">
    ...
    <div class="form-group">
      ...
      <select 
        id="layout"
        bind:value={question.config.layout}
        class="select"
      >
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.showNumbers}
          class="checkbox"
        />
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.animation}
          class="checkbox"
        />
  ...
  <div class="section">
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.allowPartial}
          class="checkbox"
        />
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.tieBreaking}
          class="checkbox"
        />
