<script lang="ts">
  ...
  $effect(() => {
    ...
    if (!question.config.format || !question.config.format.includes(question.config.mode === 'time' ? ':' : '-')) {
...
<div class="designer-panel">
  ...
  <div class="form-group">
    ...
    <select 
      id="mode"
      bind:value={question.config.mode}
      class="select"
    >
  ...
  <div class="section">
    ...
    {#if question.config.mode !== 'time'}
      <div class="form-group">
        <label class="checkbox-label">
          <input 
            type="checkbox" 
            bind:checked={question.config.showCalendar}
            class="checkbox"
          />
    ...
    <div class="form-group">
      <label class="checkbox-label">
        <input 
          type="checkbox" 
          bind:checked={question.config.defaultToToday}
          class="checkbox"
        />
    ...
    {#if question.config.mode === 'time' || question.config.mode === 'datetime'}
      <div class="form-group">
        ...
        <select 
          id="time-step"
          bind:value={question.config.timeStep}
          class="select"
        >
    ...
    <div class="section">
      ...
      <div class="form-group">
        ...
        <input
          id="min-date"
          type="date"
          bind:value={question.config.minDate}
          class="input"
        />
      ...
      <div class="form-group">
        ...
        <input
          id="max-date"
          type="date"
          bind:value={question.config.maxDate}
          class="input"
        />
