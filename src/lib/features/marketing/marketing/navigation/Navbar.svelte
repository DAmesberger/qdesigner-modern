<script lang="ts">
	...
	import Button from '$lib/shared/types/types/components/common/Button.svelte';
	import ThemeToggle from '$lib/shared/types/types/components/ui/ThemeToggle.svelte';
