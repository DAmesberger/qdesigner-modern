# 0037 — Response-set model with WebHID hardware, trigger output deferred

Status: accepted (2026-07-10, grilling session). Renumbered 2026-09-11.

This is the unchanged response/hardware decision formerly assigned the duplicate
number 0024. ADR 0024 now uniquely identifies the SQLx decision. The old filename
remains a historical link; this file is the canonical decision record.
