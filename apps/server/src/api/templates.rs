...
#[utoipa::path(
    get,
    path = "/api/organizations/{id}/templates",
    params(
    ...
    responses(
        (status = 200, description = "Question templates available in the organization", body = [QuestionTemplate]),
...
#[utoipa::path(
    ...
    responses(
        (status = 201, description = "Question template created", body = QuestionTemplate),
        (status = 403, description = "Access denied", body = crate::openapi::ErrorEnvelope),
...
#[utoipa::path(
    get,
    path = "/api/organizations/{id}/templates/{tid}",
    params(
        ("id" = Uuid, Path, description = "Organization id"),
    ...
    responses(
        (status = 200, description = "Question template", body = QuestionTemplate),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Updated question template", body = QuestionTemplate),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Question template deleted", body = crate::openapi::MessageResponse),
        (status = 403, description = "Access denied", body = crate::openapi::ErrorEnvelope),
        (status = 404, description = "Template not found", body = crate::openapi::ErrorEnvelope)
    ),
    tags = ["templates"]
