...
#[openapi(
    paths(
        ...
        api::gdpr::get_export,
        api::gdpr::erase_org,
        api::gdpr::get_erasure_status,
        api::gdpr::retry_erasure,
        ...
        api::project_invitations::list_project_invitations,
        api::project_invitations::create_project_invitation,
        api::project_invitations::get_project_invitation,
        api::project_invitations::accept_project_invitation,
        api::project_invitations::decline_project_invitation,
        api::project_invitations::revoke_project_invitation,
    ...
    components(
        schemas(
            ...
            api::project_invitations::ProjectInvitation,
            api::project_invitations::CreateProjectInvitationRequest,
            api::project_invitations::ProjectInvitationDetail,
            api::project_invitations::ProjectInvitationProjectSummary,
            api::project_invitations::ProjectInvitationInviterSummary,
