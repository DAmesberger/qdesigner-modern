	...
	const footerLinks = {
		product: {
			...
			links: [
				...
				{ name: 'Designer', href: '/features#designer' },
			...
			<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
				...
				<div class="col-span-2 md:col-span-3 lg:col-span-1">
					<div class="flex items-center gap-2 mb-4">
						...
						<span class="font-bold text-xl">QDesigner</span>
					</div>
					<p class="text-sm text-muted-foreground mb-4">
						Modern questionnaire platform for psychological and behavioral research.
					</p>
		...
		<div class="border-t border-border py-8">
			<div class="flex flex-col md:flex-row justify-between items-center gap-4">
				<p class="text-sm text-muted-foreground">
					© {currentYear} QDesigner. All rights reserved.
				</p>
