...
export async function ensureModulesRegistered(): Promise<void> {
  ...
  registrationPromise = (async () => {
    ...
    registerModule({
      ...getModuleDefinition('single-choice'),
      components: multipleChoiceMetadata.components,
    });
    registerModule({
      ...getModuleDefinition('instruction'),
      components: textInstructionMetadata.components,
    });
    registerModule({
      ...getModuleDefinition('media-display'),
      components: textInstructionMetadata.components,
    });
