...
test.describe('@fullstack portable draft import', () => {
  test('previews a definition, creates a draft, and preserves it through collaboration and reload', async ({
    page,
    request,
  }) => {
    ...
    const definition = {
      ...
      questionnaire: {
        name,
        description: 'Portable introduction',
        version: '2.3.4',
        defaultLocale: 'de',
      },
      assets: {},
        ...
        pages: [
          {
            id: 'introduction',
            name: 'Introduction',
            blocks: [{ id: 'copy', name: 'Copy', type: 'standard', questionIds: ['welcome'] }],
          },
        ],
      },
      flow: [],
